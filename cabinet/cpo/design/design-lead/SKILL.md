...
1. **Read the Product Spec** from `cabinet/cpo/doc-store/product/product-review/`
...
```
cabinet/cpo/doc-store/design/design-lead/{project}/cross-platform-flow.md
cabinet/cpo/doc-store/design/design-lead/{project}/design-review-{platform}-{date}.md
cabinet/cpo/doc-store/design/design-lead/design-system/tokens-v{version}.md
cabinet/cpo/doc-store/design/design-lead/design-system/component-library.md
cabinet/cpo/doc-store/design/design-lead/design-system/changelog.md
```
