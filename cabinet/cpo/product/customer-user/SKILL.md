...
---
> **Important:** These are audience templates. For each specific product, flesh them out with real demographics, product-specific goals, actual competing alternatives, and audience-specific usage contexts. Save the product-specific audience profiles to `cabinet/cpo/doc-store/audience/{product}/personas.md`.
...
- `cabinet/cpo/doc-store/audience/{product}/scenarios-{feature}.md`: Test scenarios per audience archetype
- `cabinet/cpo/doc-store/audience/{product}/feedback-{feature}.md`: Audience-tagged user feedback
- `cabinet/cpo/doc-store/audience/{product}/conflicts-{feature}.md`: Cross-audience conflict map
- `cabinet/cpo/doc-store/audience/{product}/uat-report-{version}.md`: UAT sign-off report
