...
- Read the CEO vision document from `cabinet/cpo/doc-store/ceo/{project-name}/`
...
```
cabinet/cpo/doc-store/product/product-review/{project-name}/product-definition-{YYYY-MM-DD}.md
```
