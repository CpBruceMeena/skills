...
- Read design specs from `cabinet/cpo/design-lead/design-android/doc-store/{project}/feature-{name}/`
...
```
cabinet/cto/engineering-manager/android/doc-store/feature-{name}/architecture.md
cabinet/cto/engineering-manager/android/doc-store/feature-{name}/compose-design.md
cabinet/cto/engineering-manager/android/doc-store/feature-{name}/offline-strategy.md
```
