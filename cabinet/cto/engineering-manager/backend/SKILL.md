...
- Read database schema from `cabinet/cto/engineering-manager/database/doc-store/feature-{name}/`
...
```
cabinet/cto/engineering-manager/backend/doc-store/feature-{name}/architecture.md
cabinet/cto/engineering-manager/backend/doc-store/feature-{name}/api-design.md
cabinet/cto/engineering-manager/backend/doc-store/feature-{name}/deployment.md
```
