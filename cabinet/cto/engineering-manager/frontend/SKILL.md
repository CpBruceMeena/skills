...
- Read design specs from `cabinet/cpo/design-lead/design-desktop-web/doc-store/{project}/feature-{name}/`
- Read backend API contracts from `cabinet/cto/engineering-manager/backend/doc-store/feature-{name}/`
...
```
cabinet/cto/engineering-manager/frontend/doc-store/feature-{name}/architecture.md
cabinet/cto/engineering-manager/frontend/doc-store/feature-{name}/component-tree.md
cabinet/cto/engineering-manager/frontend/doc-store/feature-{name}/api-contracts.md
```
