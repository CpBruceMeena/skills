...
- Read design specs from `cabinet/cpo/design-lead/design-ios/doc-store/{project}/feature-{name}/`
...
```
cabinet/cto/engineering-manager/ios/doc-store/feature-{name}/architecture.md
cabinet/cto/engineering-manager/ios/doc-store/feature-{name}/swiftui-design.md
cabinet/cto/engineering-manager/ios/doc-store/feature-{name}/offline-strategy.md
```
