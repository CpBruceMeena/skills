...
- Read backend architecture from `cabinet/cto/engineering/engineering-backend/doc-store/feature-{name}/`
...
```
cabinet/cto/engineering/engineering-database/doc-store/feature-{name}/schema.md
cabinet/cto/engineering/engineering-database/doc-store/feature-{name}/migrations.md
cabinet/cto/engineering/engineering-database/doc-store/feature-{name}/queries.md
```
